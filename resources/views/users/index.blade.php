...
<div class="row">
        <div class="col-md-12">
                ...
                <table class="table">
                    ...
                    <a href="{!! route('users.create') !!}" type="button" class="btn btn-primary btn-flat opciones" style=" position: absolute; margin-left: 120px; z-index: 1; border-radius:5px;">
                    ...
                    <tbody>
                        ...
                        @foreach ($users as $user)
                            ...
                            <tr @if ($user->status == 0) class="danger" @endif>
                                ...
                                <td class="text-left bold">{{$user->name}}</td>
                                <td class="text-center">{{$user->ci}}</td>
                                <td class="text-center">{{$user->email}}</td>
                                <td class="text-center">{{$user->phone}}</td>
                                <td class="text-center">{{$user->management->code}}</td>
