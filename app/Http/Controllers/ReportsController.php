...
class ReportsController extends Controller
{
    ...
    public function test4(){
        ...
        Excel::create('Test-'.date('YmdHis'), function($excel) {
            $excel->sheet('Vehiculos', function($sheet) {
                ...
                $vehicle = Vehicle::all();
                // Sheet manipulation
                $sheet->loadView('reports.excel.vehicles', array('vehicles' => $vehicle));
    ...
    public function test5(){
        ...
        Excel::create('Test-'.date('YmdHis'), function($excel) {
            $excel->sheet('Gerencias', function($sheet) {

                $management = Management::all();
                // Sheet manipulation
                $sheet->loadView('reports.excel.gerencias', array('managements' => $management));
